    ...
    extend(ColorAxis.prototype, {
            ...
            each(userOptions.dataClasses, function (dataClass, i) {
                ...
                if (!dataClass.color) {
                    if (options.dataClassColor === 'category') {
                        ...
                        dataClass.color =
                            axis.tweenColors(Color(options.minColor), Color(options.maxColor),
        ...
        toColor: function (value, point) {
            ...
            if (dataClasses) {
                ...
                while (i--) {
                    ...
                    from = dataClass.from;
                    to = dataClass.to;
                    if ((from === UNDEFINED || value >= from) && (to === UNDEFINED || value
                                                                  <= to)) {
        ...
        getDataClassLegendSymbols: function () {
            ...
            each(this.dataClasses, function (dataClass, i) {
                ...
                // Assemble the default name. This can be overridden by
                // legend.options.labelFormatter
                name = '';
                if (from === UNDEFINED) {
                    name = '< ';
    ...
    var colorSeriesMixin = {
        ...
        translateColors: function () {
            ...
            each(this.data, function (point) {
                ...
                color =
                    value === null ? nullColor : colorAxis ? colorAxis.toColor(value, point)
