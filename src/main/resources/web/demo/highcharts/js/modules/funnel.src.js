        ...
        translate: function () {
            ...
            series.getWidthAt = getWidthAt = function (y) {
                return y > height - neckHeight || height === neckHeight ?
                       neckWidth :
                       neckWidth + (width - neckWidth) * ((height - neckHeight - y) / (height
                                                                                       - neckHeight));
            };
            series.getX = function (y, half) {
                return centerX + (half ? -1 : 1) * ((getWidthAt(reversed ? plotHeight - y : y) / 2)
            ...
            each(data, function (point) {
                ...
                //tempWidth = neckWidth + (width - neckWidth) * ((height - neckHeight - y1) /
                // (height - neckHeight));
