...
(function (H) {
    ...
    ColumnSeries.prototype.animateDrilldown = function (init) {
        var series = this,
            ...
            animateFrom = this.chart.drilldownLevels[this.chart.drilldownLevels.length
                                                     - 1].shapeArgs,
                ...
                if (animationOptions) {
                    ...
                    graphic.animate(level.shapeArgs, H.merge(animationOptions, {
                        step: function (val, fx) {
                            if (fx.prop === 'start' && startColor.length === 4 && endColor.length
                                === 4) {
                                this.attr({
                ...
                if (!init) {
                    each(this.points, function (point, i) {
                        ...
                        point.graphic
                            ...
                            }))[animationOptions ? 'animate' : 'attr'](point.shapeArgs,
