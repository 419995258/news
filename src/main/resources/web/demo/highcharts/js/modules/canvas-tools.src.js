    ...
    function build() {
        ...
        svg.AspectRatio =
            function (ctx, aspectRatio, width, desiredWidth, height, desiredHeight, minX, minY,
                ...
                if (refX.hasValue() && refY.hasValue()) {
                    ctx.translate(-scaleMin * refX.Length.toPixels('x'),
            ...
            this.setContext = function (ctx) {
                ...
                if (this.style('fill').Definition.isUrl()) {
                    ...
                    if (this.style('fill-opacity').hasValue()) {
                        fillStyle =
                            fillStyle.Color.addOpacity(this.style('fill-opacity').value);
                    }
                ...
                if (this.style('stroke').Definition.isUrl()) {
                    ...
                    if (this.style('stroke-opacity').hasValue()) {
                        strokeStyle =
                            strokeStyle.Color.addOpacity(this.style('stroke-opacity').value);
                    }
                    ctx.strokeStyle =
                ...
                if (this.style('stroke-width').hasValue()) {
                    ctx.lineWidth =
                        this.style('stroke-width').Length.toPixels();
                }
                ...
                if (typeof (ctx.font) != 'undefined') {
                    ctx.font = svg.Font.CreateFont(
                        ...
                        this.style('font-size').hasValue() ? this.style('font-size').Length
                                                                 .toPixels() + 'px' : '',
        ...
        svg.Element.svg = function (node) {
            ...
            this.setContext = function (ctx) {
                ...
                if (typeof (this.root) == 'undefined' && this.attribute('width').hasValue()
                    ...
                    switch (pp.command.toUpperCase()) {
                        ...
                        case 'A':
                            while (!pp.isCommandOrEnd()) {
                                ...
                                pp.addMarkerAngle(halfWay, (a1 + ad) / 2 + (sweepFlag == 0 ? 1 : -1)
                                                           * Math.PI / 2);
        ...
        svg.Element.stop = function (node) {
            ...
            if (this.style('stop-opacity').hasValue()) {
                stopColor =
                    stopColor.Color.addOpacity(this.style('stop-opacity').value);
            }
                ...
                for (var i = 0; i < this.children.length; i++) {
                    ...
                    if (child.attribute('x').hasValue()) {
                        ...
                        if (child.attribute('dx').hasValue()) {
                            x +=
                                child.attribute('dx').Length.toPixels('x');
                        }
                        child.x = x;
                    }
                    ...
                    if (child.attribute('y').hasValue()) {
                        ...
                        if (child.attribute('dy').hasValue()) {
                            y +=
                                child.attribute('dy').Length.toPixels('y');
                        }
                        child.y = y;
                    }
                    y = child.y;
        ...
        svg.Element.use = function (node) {
            ...
            this.setContext = function (ctx) {
                ...
                if (this.attribute('y').hasValue()) {
                    ctx.translate(0, this.attribute('y').Length
                        .toPixels('y'));
                }
            }
                ...
                for (var y = 0; y < height; y++) {
                    for (var x = 0; x < width; x++) {
                        ...
                        for (var rgba = 0; rgba < 4; rgba++) {
                            var sum = mask[0] * (a == 0 ? 255 : imGet(src, x, y, width, height,
                                                                      rgba)) * (a == 0 || rgba == 3
                                                                                ? 1 : a);
                            for (var i = 1; i < mask.length; i++) {
                                var a1 = imGet(src, Math.max(x - i, 0), y, width, height, 3) / 255;
                                var a2 = imGet(src, Math.min(x + i, width - 1), y, width, height, 3)
                                         / 255;
                                sum += mask[i] *
                                       ((a1 == 0 ? 255 : imGet(src, Math.max(x - i, 0), y, width,
                                                               height, rgba)) * (a1 == 0 || rgba
                                                                                 == 3 ? 1 : a1) +
                                        (a2 == 0 ? 255 : imGet(src, Math.min(x + i, width - 1), y,
        ...
        svg.loadXmlDoc = function (ctx, dom) {
            ...
            var draw = function () {
                ...
                if (svg.opts != null && svg.opts['scaleWidth'] != null && svg.opts['scaleHeight']
                    != null) {
                    ...
                    if (e.attribute('height').hasValue()) {
                        yRatio =
                            e.attribute('height').Length.toPixels('y') / svg.opts['scaleHeight'];
                    }
    ...
    extend(CanVGRenderer.prototype, {
        ...
        configure: function (chart) {
            ...
            addEvent(chart, 'tooltipRefresh', function (args) {
                ...
                position =
                    chart.tooltip.getPosition(tooltipDiv.offsetWidth, tooltipDiv.offsetHeight,
