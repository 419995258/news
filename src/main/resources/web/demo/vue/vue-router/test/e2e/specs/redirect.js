module.exports = {
    'redirect': function (browser) {
        browser
            ...
            .assert
            .attributeContains('li:nth-child(2) a', 'href', '/redirect/relative-redirect?foo=bar')
            ...
            .assert
            .attributeContains('li:nth-child(6) a', 'href', '/redirect/dynamic-redirect?to=foo')
            ...
            .assert
            .attributeContains('li:nth-child(9) a', 'href', '/redirect/redirect-with-params/123')
