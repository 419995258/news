...
var indexApp = angular.module('indexApp',
                              ['ui.router', 'ui.bootstrap', 'phonecatFilters', 'tm.pagination',
...
indexApp.controller('indexController',
                    function ($scope, $http, $cookies, $rootScope, $state, $stateParams) {
                        ...
                        $scope.friends = [];
                        $scope.friends =
                            [{'friendName': '淘宝', 'href': 'http://www.taobao.com/'},
                                {'friendName': '京东', 'href': 'http://www.jd.com/'},
                                {'friendName': '唯品会', 'href': 'http://www.vip.com/'},
                                {'friendName': '百度', 'href': 'http://www.baidu.com/'}];
