...
(function (global) {
    var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript,
        mainScript, subPath, version = '2.1.15',
        commentRegExp = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg,
        cjsRequireRegExp = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,
        jsSuffixRegExp = /\.js$/, currDirRegExp = /^\.\//, op = Object.prototype,
        ostring = op.toString, hasOwn = op.hasOwnProperty, ap = Array.prototype, apsp = ap.splice,
        isBrowser = !!(typeof window !== 'undefined'
                       && typeof navigator !== 'undefined' && window.document),
    ...
    function newContext(contextName) {
        var inCheckLoaded, Module, context, handlers, checkLoadedTimeoutId, config = {
            ...
            enabledRegistry = {}, undefEvents = {}, defQueue = [], defined = {}, urlFetched = {},
        ...
        function normalize(name, baseName, applyMap) {
            var pkgMain, mapValue, nameParts, i, j, nameSegment, lastIndex, foundMap, foundI,
                foundStarMap, starI, normalizedBaseParts,
        ...
        function makeModuleMap(name, parentModuleMap, isNormalized, applyMap) {
            var url, pluginModule, suffix, nameParts, prefix = null,
                parentName = parentModuleMap ? parentModuleMap.name : null, originalName = name,
                isDefine = true, normalizedName = '';
            ...
            suffix =
                prefix && !pluginModule && !isNormalized ? '_unnormalized' + (unnormalizedCounter +=
                    1) : '';
        ...
        function checkLoaded() {
            var err, usingPathFallback, waitInterval = config.waitSeconds * 1000,
                ...
                noLoads = [], reqCalls = [], stillLoading = false, needCycleCheck = true;
        ...
        Module.prototype = {
            ...
            check: function () {
                ...
                var err, cjsModule, id = this.map.id, depExports = this.depExports,
                    exports = this.exports, factory = this.factory;
            ...
            callPlugin: function () {
                ...
                on(pluginMap, 'defined', bind(this, function (plugin) {
                    var load, normalizedMap, normalizedMod,
                        bundleId = getOwn(bundlesMap, this.map.id), name = this.map.name,
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                if (cfg.packages) {
                    each(cfg.packages, function (pkgObj) {
                        ...
                        config.pkgs[name] =
                            pkgObj.name + '/' + (pkgObj.main || 'main').replace(currDirRegExp, '')
                ...
                mixin(localRequire, {
                    ...
                    toUrl: function (moduleNamePlusExt) {
                        ...
                        return context.nameToUrl(
                            normalize(moduleNamePlusExt, relMap && relMap.id, true), ext, true);
                    },
            ...
            nameToUrl: function (moduleName, ext, skipExt) {
                var paths, syms, i, parentModule, url, parentPath, bundleId,
                ...
                if (req.jsExtRegExp.test(moduleName)) {
                    ...
                    url =
                        (url.charAt(0) === '/' || url.match(/^[\w\+\.\-]+:/) ? '' : config.baseUrl)
                        + url;
                }
            ...
            onScriptLoad: function (evt) {
                ...
                //all old browsers will be supported, but this one was easy enough
                //to support and still makes sense.
                if (evt.type === 'load' || (readyRegExp.test(
    ...
    req.createNode = function (config, moduleName, url) {
        var node = config.xhtml ? document.createElementNS('http://www.w3.org/1999/xhtml',
    ...
    req.load = function (context, moduleName, url) {
        ...
        if (isBrowser) {
            ...
            if (node.attachEvent &&
                ...
                !(node.attachEvent.toString && node.attachEvent.toString().indexOf('[native code')
                < 0) && !isOpera) {
    ...
    define = function (name, deps, callback) {
        ...
        if (!deps && isFunction(callback)) {
            ...
            if (callback.length) {
                callback.toString().replace(commentRegExp, '')
